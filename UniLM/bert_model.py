...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        attention_output, attention_matrix = self.attention(hidden_states, attention_mask,
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        # print(extended_attention_mask.size())   # torch.Size([2, 1, 1, 44])
        ...
        if attention_mask is not None:
            ...
            # print(extended_attention_mask.size())   # torch.Size([2, 1, 25, 25])
