...
def predict(model, vocab2id, context):
    ...
    for step in range(max_len):
        ...
        predictions = model.decode(words, target_mask, encoded, input_mask, input_ids, is_pointer=False)
        # predictions = model.decode(words, target_mask, encoded, input_mask, input_ids)
