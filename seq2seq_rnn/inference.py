...
def predict(model, vocab, text, max_len=60):
    ...
    with torch.no_grad():
        ...
        for t in range(max_len):
            ...
            logits, prev_hidden, attention_weights = model.decoder(decoder_emb, prev_hidden, enc_output, src_lengths)
...
if __name__ == '__main__':
    ...
    # epoch_11.bin
    # epoch_2.bin
    # model.load_state_dict(torch.load('./output_dir/epoch_14.bin', map_location='cpu'))
